...
Hooks:Add("MenuManagerInitialize", "MenuManagerInitialize_UltimateTrainer", function(menuManager)
    ...
    MenuHelper:LoadFromJsonFile(modPath .. "menus/main.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/player.json", nil, settings)
    
    MenuHelper:LoadFromJsonFile(modPath .. "menus/level.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/infamy-rank.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/money.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/continental-coins.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/skill-points.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/perk-points.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/inventory.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/trophies.json", nil, settings)
    MenuHelper:LoadFromJsonFile(modPath .. "menus/steam-achievements.json", nil, settings)
end)
