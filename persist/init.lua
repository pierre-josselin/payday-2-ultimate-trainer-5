...
UT.tempSettings.groupSpawn.animations = UT.Tables.groupSpawnAnimations[1]
UT.tempSettings.groupSpawn.areaSize = 200
UT.tempSettings.groupSpawn.peopleNumber = 50
